...
shaderprogram2* sp;
shaderprogram2* sp_simpler;
shaderprogram2* sp_text;
shaderprogram2* sp_sphere;
shaderprogram2* sp_cylinder;


void initShaders() {
	sp = new shaderprogram2("v_shader.glsl", NULL, "f_shader.glsl");
	
	sp_sphere = new shaderprogram2("v_sphere_shader.glsl", NULL, "f_sphere_shader.glsl");
	sp_cylinder = new shaderprogram2("v_cylinder_shader.glsl", NULL, "f_cylinder_shader.glsl");

	sp_simpler = new shaderprogram2("v_simplest.glsl", NULL, "f_simplest.glsl");
	sp_text = new shaderprogram2("v_text.glsl", NULL, "f_text.glsl");
}
